...
plot_HR1 <- ggplot(individual_HR1, aes(x=date, y=value)) +
  geom_line() +
  theme_bw() +
  ggtitle("HR of user 1239500066 throughout the day") +
  xlab("Date/time") +
  ylab("Heart rate (beats/min)")
print(plot_HR1)
...
boxplot_HR1 <- ggplot(individual_HR1, 
  ...
  stat_summary(fun.data = n_fun, geom = "text", fun.y = median, colour = "black",
               size= 2, fontface="bold") +
  #stat_summary(fun.data = mean.n, geom = "text", fun.y = mean, colour = "red") +
  xlab("Hour of 2018-02-09") +
  ylab ("Heart rate (beats/min)")
print(boxplot_HR1)
...
plot_HR2 <- ggplot(individual_HR2, aes(x=date, y=value)) +
  ...
  xlab("Date/time") +
  ylab("Heart rate (beats/min)") +
  ggtitle("HR of user 6755366276696782 throughout the day")
print(plot_HR2)
...
boxplot_HR2 <- ggplot(individual_HR2, 
  ...
  #stat_summary(fun.data = mean.n, geom = "text", fun.y = mean, colour = "red") +
  xlab("Hour of 2018-02-09 (Day of no exercise)") +
  ylab ("Heart rate (beats/min)") +
  ggtitle("HR of user 6755366276696782 throughout the day")
print(boxplot_HR2)
...
plot_HR3 <- ggplot(individual_HR3, aes(x=date, y=value)) +
  geom_line() +
  theme_bw() +
  ggtitle("HR of user 6755366276696785 throughout the day") +
  xlab("Date/time") +
  ylab("Heart rate (beats/min)")
print(plot_HR3)
...
boxplot_HR3 <- ggplot(individual_HR3, 
  ...
  stat_summary(fun.data = n_fun, geom = "text", 
               fun.y = median, colour = "black", size= 2, fontface="bold") +
  #stat_summary(fun.data = mean.n, geom = "text", fun.y = mean, colour = "red") +
  xlab("Hour of 2018-02-08") +
  ylab ("Heart rate (beats/min)")+
  ggtitle("HR of user 6755366276696785 throughout the day")
print(boxplot_HR3)

  ##lowest quartile HR analysis
...
step_perDay <- steps_user_raw %>% group_by(userId, day) %>%
  summarise(total_steps=sum(value1))
